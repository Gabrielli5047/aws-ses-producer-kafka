...
public class SESService {
    public static void sendMessage(String message) {
        ...
        String bodyHTML = "<html>"
                + "<head></head>"
                + "<body>"
                + "<h1>Solicitacao enviada com sucesso ao kafka!</h1>"
                + "<p> Realizado atravez do Java.</p>"
                + "</body>"
                + "</html>";

        try {
            send(client, "gabrielli.meloo16@gmail.com", "gabrielli.meloo16@gmail.com", "Email de teste",
                    bodyText, bodyHTML);
            client.close();
